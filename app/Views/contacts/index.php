...
$linkMessages = [
    'linked' => ['color' => '#166534', 'text' => 'Client linked to contact successfully.'],
    'unlinked' => ['color' => '#166534', 'text' => 'Client unlinked from contact successfully.'],
    'exists' => ['color' => '#b91c1c', 'text' => 'This contact-client link already exists.'],
    'missing' => ['color' => '#b91c1c', 'text' => 'That contact-client link does not exist.'],
    'invalid' => ['color' => '#b91c1c', 'text' => 'Please select a valid contact and client.'],
...
<?php if ($created): ?>
    <p style="color:#166534; margin: 10px 0;">Contact created successfully.</p>
<?php endif; ?>
...
<form action="/contacts" method="post" style="margin: 16px 0 20px 0; display: grid; gap: 10px; max-width: 460px;">
    <div>
...
<?php if ($contacts !== [] && $clients !== []): ?>
    <h3 style="margin: 18px 0 8px 0;">Link Clients to Contacts</h3>
...
<?php else: ?>
    <p>Showing <?= count($contacts) ?> contact(s).</p>
    <table style="width:100%; border-collapse: collapse;">
        ...
        <tr>
            ...
            <th style="text-align:left; border-bottom: 1px solid #e5e7eb; padding: 8px 6px;">Linked Clients</th>
        </tr>
        </thead>
        <tbody>
        <?php foreach ($contacts as $contact): ?>
...
<?php if ($links === []): ?>
    <p>No contact-client links yet.</p>
<?php else: ?>
    <table style="width:100%; border-collapse: collapse;">
        <thead>
        <tr>
